...
lv_obj_t* startup_create() {
    ...
    lv_obj_set_style_text_color(sub, lv_color_hex(0x556688), 0);
    ...
    lv_obj_set_style_arc_color(spinner, lv_color_hex(0x2266CC), LV_PART_INDICATOR);
    lv_obj_set_style_arc_color(spinner, lv_color_hex(0x1A1A30), LV_PART_MAIN);
    ...
    lv_label_set_text(s_status_lbl, "Connecting to boat network\xe2\x80\xa6");
    lv_obj_set_style_text_font(s_status_lbl, &lv_font_montserrat_14, 0);
    lv_obj_set_style_text_color(s_status_lbl, lv_color_hex(0x556688), 0);
    ...
    lv_obj_set_style_bg_color(btn, lv_color_hex(0x1C1C30), 0);
    lv_obj_set_style_bg_color(btn, lv_color_hex(0x161628), LV_STATE_PRESSED);
    lv_obj_set_style_border_color(btn, lv_color_hex(0x2E2E50), 0);
    ...
    lv_obj_set_style_text_color(btn_lbl, lv_color_hex(0x445566), 0);
    lv_obj_center(btn_lbl);

    lv_obj_t* note = lv_label_create(scr);
    lv_label_set_text(note, "configure network settings");
    lv_obj_set_style_text_font(note, &lv_font_montserrat_12, 0);
    lv_obj_set_style_text_color(note, lv_color_hex(0x303050), 0);
